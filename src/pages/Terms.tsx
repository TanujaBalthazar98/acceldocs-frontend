        ...
        <main className="container mx-auto px-6 py-16 max-w-4xl">
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none space-y-8">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Docspeare is a documentation platform that allows you to organize, manage, and publish documentation from your Google Workspace. We provide tools to sync, structure, and share your documents with your team and the public.
              </p>
            </section>
            ...
            <section>
              ...
              <h3 className="text-xl font-medium text-foreground mb-3">5.2 Our Content</h3>
              <p className="text-muted-foreground leading-relaxed">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                <a href="mailto:legal@docspeare.io" className="text-primary hover:underline">
                  legal@docspeare.io
                </a>
              </p>
            </section>

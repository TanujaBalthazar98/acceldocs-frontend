      ...
      <div className="relative mx-auto max-w-6xl px-6 py-10 md:py-16">
        <div className="mb-12 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xl font-bold tracking-tight">Documentation Platform</p>
              <p className="text-xs text-slate-600">Google Docs to Production Docs</p>
            </div>
          </div>
          <Button
            variant="outline"
        ...
        <div className="rounded-3xl border border-slate-200 bg-white/90 p-8 shadow-xl backdrop-blur md:p-12">

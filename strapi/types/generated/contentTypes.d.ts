...
export interface ApiDocumentCacheDocumentCache
  extends Struct.CollectionTypeSchema {
  collectionName: 'document_cache';
  info: {
    displayName: 'Document Cache';
    pluralName: 'document-caches';
    singularName: 'document-cache';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    content_html_encrypted: Schema.Attribute.Text;
    content_text_encrypted: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    document: Schema.Attribute.Relation<'manyToOne', 'api::document.document'>;
    headings_encrypted: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::document-cache.document-cache'
    > &
      Schema.Attribute.Private;
    ...
    >;
    published_content_html_encrypted: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiDocumentDocument extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    google_doc_id: Schema.Attribute.String;
    google_modified_at: Schema.Attribute.DateTime;
    ...
    >;
    project: Schema.Attribute.Relation<'manyToOne', 'api::project.project'>;
    project_version: Schema.Attribute.Relation<
      'manyToOne',
      'api::project-version.project-version'
    >;
    published_content_html: Schema.Attribute.Text;
    published_content_id: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDomainDomain extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    domain_type: Schema.Attribute.Enumeration<['custom', 'subdomain']> &
    ...
    project: Schema.Attribute.Relation<'manyToOne', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
    ssl_status: Schema.Attribute.Enumeration<
...
export interface ApiInvitationInvitation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    role: Schema.Attribute.Enumeration<
      ['owner', 'admin', 'editor', 'viewer', 'reviewer']
    > &
...
export interface ApiOrgRoleOrgRole extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['owner', 'admin', 'editor', 'viewer']> &
      Schema.Attribute.DefaultTo<'viewer'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrganizationOrganization
  ...
  attributes: {
    ...
    custom_docs_domain: Schema.Attribute.String;
    custom_links: Schema.Attribute.JSON;
    domain: Schema.Attribute.String & Schema.Attribute.Unique;
    domains: Schema.Attribute.Relation<'oneToMany', 'api::domain.domain'>;
    drive_folder_id: Schema.Attribute.String;
    drive_permissions_last_synced_at: Schema.Attribute.DateTime;
    ...
    mcp_enabled: Schema.Attribute.Boolean;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    openapi_spec_json: Schema.Attribute.JSON;
    openapi_spec_url: Schema.Attribute.String;
    owner: Schema.Attribute.Relation<
      'manyToOne',
      'plugin::users-permissions.user'
    >;
    ...
    show_featured_projects: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    show_search_on_landing: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
...
export interface ApiPageFeedbackPageFeedback
  extends Struct.CollectionTypeSchema {
  collectionName: 'page_feedback';
  info: {
    displayName: 'Page Feedback';
    pluralName: 'page-feedbacks';
    singularName: 'page-feedback';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    document: Schema.Attribute.Relation<'manyToOne', 'api::document.document'>;
    feedback_type: Schema.Attribute.Enumeration<
      ['rating', 'comment', 'suggestion', 'issue']
    > &
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::page-feedback.page-feedback'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiProjectVersionProjectVersion
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    project: Schema.Attribute.Relation<'manyToOne', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
    semver_major: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    semver_minor: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    semver_patch: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    documents: Schema.Attribute.Relation<'oneToMany', 'api::document.document'>;
    drive_folder_id: Schema.Attribute.String;
    drive_parent_id: Schema.Attribute.String;
    is_published: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    publishedAt: Schema.Attribute.DateTime;
    show_version_switcher: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    slug: Schema.Attribute.String;
    topics: Schema.Attribute.Relation<'oneToMany', 'api::topic.topic'>;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSlugHistorySlugHistory extends Struct.CollectionTypeSchema {
  collectionName: 'slug_history';
  info: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    entity_id: Schema.Attribute.String;
    entity_type: Schema.Attribute.Enumeration<['project', 'topic', 'document']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    new_slug: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::document-cache.document-cache': ApiDocumentCacheDocumentCache;
      ...
      'api::page-feedback.page-feedback': ApiPageFeedbackPageFeedback;
